    ...
    <section className="relative w-full mx-auto">
      <div className="flex flex-col items-center justify-center">
        ...
        <div className="relative flex items-center justify-center w-full mt-10">
          ...
          <div className="text-center text-xl px-4 w-[50vw] text-white">
            Our platform aims to empower SMEs by providing essential tools and
            resources, fostering collaboration, and connecting them with
            investors.
          </div>
          <div className="flex-grow border-t border-white"></div>
        </div>
